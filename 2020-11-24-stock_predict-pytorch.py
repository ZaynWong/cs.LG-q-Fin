...
# 需要自己到网站www.tushare.pro注册获得token
ts.set_token('7df2733e5280cd6eed278599e938e66d9a8c84b02393dfae0728fcfc')
# A股复权行情接口pro_bar，adj为复权类型：None未复权、qfq前复权、hfq后复权 , 默认None
...
if __name__ == "__main__":
    # ----参数配置--------------------
    distance_test = 30  # 训练数据的截止点离最新数据的距离

    predict_number = 15  # 连续预测天数
